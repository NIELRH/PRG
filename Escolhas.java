...
public class Main {
    ...
    public static class Player {
        ...
        // BUFFERS
        public void Buff_Vida_Nivel1(){ vida += 25; vidaMax = vida;}
        public void Buff_Vida_Nivel2(){  vida += 30; vidaMax = vida;}
        public void Buff_Vida_Nivel3(){vida += 40; vidaMax = vida;}
        public void Buff_Vida_Nivel4(){ vida += 45; vidaMax = vida;}
        public void Buff_Vida_Nivel5(){vida += 50; vidaMax = vida;}


        public void Buff_Damage_Nivel1(){dano += 7;}
        public void Buff_Damage_Nivel2(){dano += 10;}
        public void Buff_Damage_Nivel3(){dano += 14;}
        public void Buff_Damage_Nivel4(){dano += 17;}
        public void Buff_Damage_Nivel5(){dano += 20;}
        
        
        public void Escolha_De_Buffers( int Escolha_Buffer_Vida, int Escolha_Buffer_Dano , int Ecolha_Buffer_Qtd_Cura ){
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        player.ResetVida(); player.Buff_Vida_Nivel1();

        combate(player , inimigo_Goblin, sc);
        player.ResetVida(); player.Buff_Vida_Nivel2();

        combate(player ,inimigo_Demonio, sc);
         player.ResetVida(); player.Buff_Vida_Nivel3();

        combate(player , inimigo_CavaleiroNegro , sc);
        player.ResetVida(); player.Buff_Vida_Nivel4();

        combate(player , inimigo_ReiDemonio , sc);
        player.ResetVida(); player.Buff_Vida_Nivel5();
