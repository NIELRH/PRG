...
public class Main {
    ...
    public static void Titulo_BlooDivine() throws InterruptedException {
    ...
    public static void mostrarMenu(Inimigo inimigo, Player player, int quantidadeCura, int round) {
        ...
        System.out.println(cores.vermelho + "👾 Vida " + inimigo.nome + ": " + inimigo.vida + "/" + inimigo.vidaMaxInimigo + cores.reset);
        ...
        while (player.vida > 0 && enemy.vida > 0) {
            ...
            switch (escolha) {
                ...
                case 1:
                    ...
                    // O inimigo ataca agora, fora do IF do acerto do player
                    if (enemy.vida > 0) {
                        Thread.sleep(500); // Pequena pausa para o jogador ler que errou/acertou
                        enemy.atacar(player);
